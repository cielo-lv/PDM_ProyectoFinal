...
class Ninja04Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninja04)

        // Configurar enlaces
        findViewById<TextView>(R.id.link1).setOnClickListener {
            openLink("https://www.redhat.com/es/topics/security/cloud-security")
        }

        findViewById<TextView>(R.id.link2).setOnClickListener {
            openLink("https://cointelegraph.com/news/fireblocks-google-cloud-partner-enhance-pkm-security")
        }

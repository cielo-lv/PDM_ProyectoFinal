...
class Ninja02Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninja02)

        // Configurar enlaces
        findViewById<TextView>(R.id.link1).setOnClickListener {
            openLink("https://www.syook.com/post/ai-and-iot-convergence-a-new-era-in-video-surveillance-technology")
        }

        findViewById<TextView>(R.id.link2).setOnClickListener {
            openLink("https://thesai.org/Downloads/Volume15No7/Paper_99-AI_IoT_Enabled_Surveillance_Security.pdf")
        }

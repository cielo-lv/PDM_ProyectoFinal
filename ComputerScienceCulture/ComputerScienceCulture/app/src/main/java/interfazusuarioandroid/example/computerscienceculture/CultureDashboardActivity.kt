...
class CultureDashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_culture_dashboard)
        ...
        unoCard.setOnClickListener {
            val intent = Intent(this, Culture01Activity::class.java)
            startActivity(intent)
        }
        dosCard.setOnClickListener {
            val intent = Intent(this, Culture02Activity::class.java)
            startActivity(intent)
        }
        tresCard.setOnClickListener {
            val intent = Intent(this, Culture03Activity::class.java)
            startActivity(intent)
        }
        cuatroCard.setOnClickListener {
            val intent = Intent(this, Culture04Activity::class.java)
            startActivity(intent)
        }
        cincoCard.setOnClickListener {
            val intent = Intent(this, Culture05Activity::class.java)
            startActivity(intent)
        }
        seisCard.setOnClickListener {
            val intent = Intent(this, Culture06Activity::class.java)
            startActivity(intent)
        }

...
class History04Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_history04)

        //Enlaces
        findViewById<TextView>(R.id.link1).setOnClickListener {
            openLink("https://mujeresconciencia.com/2017/06/07/margaret-hamilton-la-primera-ingeniera-software/")
        }

        findViewById<TextView>(R.id.link2).setOnClickListener {
            openLink("https://www.cisinformatica.cat/es/margaret-hamilton-biografia-logros/")
        }

        findViewById<TextView>(R.id.link3).setOnClickListener {
            openLink("https://pionerasinformaticas.ujaen.es/es/pioneras-informaticas/margaret-hamilton-es")
        }

        findViewById<TextView>(R.id.link4).setOnClickListener {
            openLink("https://mujeresconciencia.com/2021/07/23/margaret-hamilton-retrato-alfabetico/")
        }

...
class Ninja01Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninja01)

        // Configurar enlaces
        findViewById<TextView>(R.id.link1).setOnClickListener {
            openLink("https://www.ramsac.com/blog/machine-learning-algorithms-in-cybersecurity/")
        }

        findViewById<TextView>(R.id.link2).setOnClickListener {
            openLink("https://medium.com/@zhonghong9998/cybersecurity-threat-detection-defending-against-malicious-attacks-with-ai-f5284b67ce4b")
        }

...
class Ninja06Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ninja06)

        // Configurar enlaces
        findViewById<TextView>(R.id.link1).setOnClickListener {
            openLink("https://www.cybersecurity.blog.aisec.fraunhofer.de/en/a-somewhat-gentle-introduction-to-lattice-based-post-quantum-cryptography/")
        }

        findViewById<TextView>(R.id.link2).setOnClickListener {
            openLink("https://www.btq.com/blog/how-will-lattice-based-cryptography-protect-us-from-quantum-computers")
        }

        findViewById<TextView>(R.id.link3).setOnClickListener {
            openLink("https://www.redhat.com/en/blog/post-quantum-cryptography-lattice-based-cryptography")
        }

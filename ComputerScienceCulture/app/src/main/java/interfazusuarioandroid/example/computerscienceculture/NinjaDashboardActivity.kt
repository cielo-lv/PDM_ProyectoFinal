...
class NinjaDashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ninja_dashboard)
        ...
        unoCard.setOnClickListener {
            val intent = Intent(this, Ninja01Activity::class.java)
            startActivity(intent)
        }
        dosCard.setOnClickListener {
            val intent = Intent(this, Ninja02Activity::class.java)
            startActivity(intent)
        }
        tresCard.setOnClickListener {
            val intent = Intent(this, Ninja03Activity::class.java)
            startActivity(intent)
        }
        cuatroCard.setOnClickListener {
            val intent = Intent(this, Ninja04Activity::class.java)
            startActivity(intent)
        }
        cincoCard.setOnClickListener {
            val intent = Intent(this, Ninja05Activity::class.java)
            startActivity(intent)
        }
        seisCard.setOnClickListener {
            val intent = Intent(this, Ninja06Activity::class.java)
            startActivity(intent)
        }

...
class History03Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_history03)

        //Enlaces
        findViewById<TextView>(R.id.link1).setOnClickListener {
            openLink("https://www.nationalgeographic.com.es/ciencia/grace-hopper-madre-programacion-informatica_22009")
        }

        findViewById<TextView>(R.id.link2).setOnClickListener {
            openLink("https://www.urv.cat/es/vida-campus/servicios/unidad-igualdad/ano-mujeres-ciencias/dones-i-ciencies/dones-matematiques-fisiques/gracemurray/")
        }

        findViewById<TextView>(R.id.link3).setOnClickListener {
            openLink("https://www.hackaboss.com/blog/grace-hopper-madre-programacion-informatica")
        }

        findViewById<TextView>(R.id.link4).setOnClickListener {
            openLink("https://www.gradiant.org/blog/mujeres-tecnologas-grace-hopper/")
        }

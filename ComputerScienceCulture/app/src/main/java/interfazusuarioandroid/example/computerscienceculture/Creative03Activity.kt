...
class Creative03Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_creative03)

        // Configurar enlaces
        findViewById<TextView>(R.id.link1).setOnClickListener {
            openLink("https://www.technologyreview.com/2023/04/11/1071104/ai-helping-historians-analyze-past/")
        }

        findViewById<TextView>(R.id.link2).setOnClickListener {
            openLink("https://creativa.ai/en/reviving-the-past-how-creativa-ai-uses-ai-to-bring-history-to-life-through-vintage-and-historical-imagery/")
        }

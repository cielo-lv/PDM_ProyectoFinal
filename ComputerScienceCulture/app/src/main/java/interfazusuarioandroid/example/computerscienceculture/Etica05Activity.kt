...
class Etica05Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_etica05)

        // Configurar enlaces
        findViewById<TextView>(R.id.link1).setOnClickListener {
            openLink("https://www.whitecase.com/insight-our-thinking/ai-watch-global-regulatory-tracker-united-states")
        }

        findViewById<TextView>(R.id.link2).setOnClickListener {
            openLink("https://www.spiceworks.com/tech/artificial-intelligence/articles/ai-regulations-around-the-world/")
        }

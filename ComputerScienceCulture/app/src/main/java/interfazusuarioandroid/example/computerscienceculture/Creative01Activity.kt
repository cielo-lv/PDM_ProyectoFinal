...
class Creative01Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_creative01)

        // Configurar enlaces
        findViewById<TextView>(R.id.link1).setOnClickListener {
            openLink("https://atriainnovation.com/blog/ciudades-inteligentes-smart-cities/")
        }

        findViewById<TextView>(R.id.link2).setOnClickListener {
            openLink("https://www.itu.int/web/pp-18/es/backgrounder/smart-sustainable-cities")
        }
